...
class DatasetService:
    ...
    @staticmethod
    def get_province_scene_by_id(scene_id: int | str | None) -> Optional[ProvinceScene]:
        """
        Fetch a ProvinceScene row by primary key. Returns None when id is invalid or not found.
        """
        if scene_id in (None, ""):
            return None
        try:
        ...
        return db.session.get(ProvinceScene, scene_id_int)
